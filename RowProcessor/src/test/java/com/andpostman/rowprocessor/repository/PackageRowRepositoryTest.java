...
class PackageRowRepositoryTest {
    ...
    void whenTryToSaveInDbEmptyPackageRow_returnError(){
    ...
    @Test
    @DisplayName("Проверка обновления талицы бд пустыми значениями")
    void whenTryToUpdate_thenReturnEmptyResult(){
        Mono<PackageRow> update = repository.update(anyInt(),anyInt());
