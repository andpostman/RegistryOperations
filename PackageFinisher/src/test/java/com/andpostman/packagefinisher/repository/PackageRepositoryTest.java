...
class PackageRepositoryTest {
    ...
    @Test
    @DisplayName("Проверка получения не существующей таблицы в БД")
    void whenTryToGetFromDbPackage_returnEmptyResult(){
        Mono<Package> aNewPackage = repository.getPackageById(-1);
        StepVerifier
                .create(aNewPackage)
                .recordWith(ArrayList::new)
                .thenConsumeWhile(x -> true)
