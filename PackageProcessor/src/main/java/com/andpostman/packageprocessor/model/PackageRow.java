...
public class PackageRow implements Persistable<Integer> {
    ...
    public boolean isNew() {
        return this.newPackageRow || id == null;
    }

    public PackageRow setAsNew(){
        this.newPackageRow = true;
        return this;
    }
}
